...
//			builder.withArgument(GeneralServerFlag.LOG_LEVEL,"error");
    ...
    public static AndroidDriver<AndroidElement> Capabilities(String appName) throws IOException, InterruptedException {
		...
		String device = System.getProperty("deviceName");	//get the device from mvn command line. remove the device from global.properties
		...
		caps.setCapability(MobileCapabilityType.DEVICE_NAME, device);//Virtual Device running with Emulator 
		//cap.setCapability(MobileCapabilityType.DEVICE_NAME, "Android Device");//Real Device connected to your Machine.
		...
		//Session takes 60 seconds to close. Before 60s you can force close (Ctrl+C) the connection. 	
	...
	String timestamp = new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
    	...
    	String scrFileName = System.getProperty("user.dir")+"\\Screenshots\\" + testCaseName + "_" + timestamp + ".png";
